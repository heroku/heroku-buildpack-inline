...
in its source tree, in a directory named "bin" (or 
`INLINE_BUILDPACK_PATH`) in the top of the git repo; this is 
the same interface all other buildpacks provide. See the 
[buildpack documentation][buildpack] for more details about 
this interface.
